...
static unsigned HOST_WIDE_INT move_by_pieces_ninsns (unsigned HOST_WIDE_INT,
						     unsigned int,
						     unsigned int);
static void move_by_pieces_1 (insn_gen_fn, enum machine_mode,
			      struct move_by_pieces_d *);
...
static void store_by_pieces_2 (insn_gen_fn, enum machine_mode,
			       struct store_by_pieces_d *);
...
static void
move_by_pieces_1 (insn_gen_fn genfun, enum machine_mode mode,
		  struct move_by_pieces_d *data)
{
...
static void
store_by_pieces_2 (insn_gen_fn genfun, enum machine_mode mode,
		   struct store_by_pieces_d *data)
{
  unsigned int size = GET_MODE_SIZE (mode);
  rtx to1, cst;
